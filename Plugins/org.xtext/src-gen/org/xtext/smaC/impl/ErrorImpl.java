 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.smaC.impl.ErrorImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.smaC.impl.ErrorImpl#getInputParams <em>Input Params</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ErrorImpl extends MinimalEObjectImpl.Container implements org.xtext.smaC.Error
{
  /**
  ...
  {
    return SmaCPackage.Literals.ERROR;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SmaCPackage.ERROR__NAME, oldName, name));
  }
  ...
  public EList<InputParam> getInputParams()
  {
    if (inputParams == null)
    {
      inputParams = new EObjectContainmentEList<InputParam>(InputParam.class, this, SmaCPackage.ERROR__INPUT_PARAMS);
    }
    return inputParams;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SmaCPackage.ERROR__INPUT_PARAMS:
