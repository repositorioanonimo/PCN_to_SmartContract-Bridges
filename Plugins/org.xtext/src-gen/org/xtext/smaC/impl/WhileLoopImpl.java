 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.smaC.impl.WhileLoopImpl#getProperties <em>Properties</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WhileLoopImpl extends UnDeterminedLoopImpl implements WhileLoop
{
  /**
  ...
  {
    return SmaCPackage.Literals.WHILE_LOOP;
  }
  ...
  public EList<Properties> getProperties()
  {
    if (properties == null)
    {
      properties = new EObjectContainmentEList<Properties>(Properties.class, this, SmaCPackage.WHILE_LOOP__PROPERTIES);
    }
    return properties;
  }
