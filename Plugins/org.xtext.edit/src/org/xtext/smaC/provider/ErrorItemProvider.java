...
/**
 * This is the item provider adapter for a {@link org.xtext.smaC.Error} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ErrorItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SmaCPackage.Literals.ERROR__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SmaCPackage.Literals.ERROR__INPUT_PARAMS);
		}
	...
	public String getText(Object object) {
		String label = ((org.xtext.smaC.Error)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(org.xtext.smaC.Error.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SmaCPackage.Literals.ERROR__INPUT_PARAMS,
