 ...
 * @generated
 */
public class PCNDoAndWaitStepAction5EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PCNDoAndWaitStepAction5EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PcnParserProvider.getParser(PcnElementTypes.PCNDoAndWaitStep_3020, getParserElement(),
					PcnVisualIDRegistry.getType(pcn.diagram.edit.parts.PCNDoAndWaitStepAction5EditPart.VISUAL_ID));
		}
		return parser;
	}
