 ...
 * @generated
 */
public class PCNReferenceNumber4EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PCNReferenceNumber4EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = PcnParserProvider.getParser(PcnElementTypes.PCNReference_3044, getParserElement(),
					PcnVisualIDRegistry.getType(pcn.diagram.edit.parts.PCNReferenceNumber4EditPart.VISUAL_ID));
		}
		return parser;
	}
