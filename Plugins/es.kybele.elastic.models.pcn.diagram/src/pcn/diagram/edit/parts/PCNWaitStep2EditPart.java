...
import pcn.diagram.edit.policies.PCNWaitStep2ItemSemanticEditPolicy;
import pcn.diagram.part.PcnVisualIDRegistry;

/**
 * @generated
 */
public class PCNWaitStep2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public PCNWaitStep2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new PCNWaitStep2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PCNWaitStepAction2EditPart) {
			((PCNWaitStepAction2EditPart) childEditPart).setLabel(getPrimaryShape().getFigurePCNWaitStepActionFigure());
			return true;
		}
		if (childEditPart instanceof PCNWaitStepCompartmentWaitProcessTags2EditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNWaitStepFigureExternalTriangle();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((PCNWaitStepCompartmentWaitProcessTags2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof PCNWaitStepCompartmentWaitProcessTags2EditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNWaitStepFigureExternalTriangle();
			pane.remove(((PCNWaitStepCompartmentWaitProcessTags2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof PCNWaitStepCompartmentWaitProcessTags2EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PcnVisualIDRegistry.getType(PCNWaitStepAction2EditPart.VISUAL_ID));
	}
