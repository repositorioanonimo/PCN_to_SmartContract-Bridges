 ...
 * @generated
 */
public class PCNProbabilitiesTagNoProbabilityEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PCNProbabilitiesTagNoProbabilityEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = PcnParserProvider.getParser(PcnElementTypes.PCNProbabilitiesTag_3208, getParserElement(),
					PcnVisualIDRegistry
							.getType(pcn.diagram.edit.parts.PCNProbabilitiesTagNoProbabilityEditPart.VISUAL_ID));
		}
		return parser;
	}
