 ...
 * @generated
 */
public class PCNOutsourcedStepAction4EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PCNOutsourcedStepAction4EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PcnParserProvider.getParser(PcnElementTypes.PCNOutsourcedStep_3034, getParserElement(),
					PcnVisualIDRegistry.getType(pcn.diagram.edit.parts.PCNOutsourcedStepAction4EditPart.VISUAL_ID));
		}
		return parser;
	}
