 ...
 * @generated
 */
public class PCNTextualTagTag3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PCNTextualTagTag3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PcnParserProvider.getParser(PcnElementTypes.PCNTextualTag_3170, getParserElement(),
					PcnVisualIDRegistry.getType(pcn.diagram.edit.parts.PCNTextualTagTag3EditPart.VISUAL_ID));
		}
		return parser;
	}
