...
public class WrappingLabel2EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(PcnVisualIDRegistry.getType(pcn.diagram.edit.parts.WrappingLabel2EditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PcnParserProvider.getParser(PcnElementTypes.PCNDecisionStepPCNPositiveDecision_4006,
					getParserElement(),
					PcnVisualIDRegistry.getType(pcn.diagram.edit.parts.WrappingLabel2EditPart.VISUAL_ID));
		}
		return parser;
	}
