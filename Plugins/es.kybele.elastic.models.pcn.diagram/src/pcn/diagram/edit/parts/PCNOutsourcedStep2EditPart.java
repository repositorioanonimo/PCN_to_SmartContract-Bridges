...
import pcn.diagram.edit.policies.PCNOutsourcedStep2ItemSemanticEditPolicy;
import pcn.diagram.part.PcnVisualIDRegistry;

/**
 * @generated
 */
public class PCNOutsourcedStep2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public PCNOutsourcedStep2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new PCNOutsourcedStep2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PCNOutsourcedStepAction2EditPart) {
			((PCNOutsourcedStepAction2EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigurePCNOutsourcedStepActionFigure());
			return true;
		}
		if (childEditPart instanceof PCNOutsourcedStepCompartmentPreparationTags2EditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNOutsourcedStepFigureExternalRectangle();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((PCNOutsourcedStepCompartmentPreparationTags2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof PCNOutsourcedStepCompartmentPreparationTags2EditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNOutsourcedStepFigureExternalRectangle();
			pane.remove(((PCNOutsourcedStepCompartmentPreparationTags2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof PCNOutsourcedStepCompartmentPreparationTags2EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PcnVisualIDRegistry.getType(PCNOutsourcedStepAction2EditPart.VISUAL_ID));
	}
