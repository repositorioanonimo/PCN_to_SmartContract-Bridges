 ...
 * @generated
 */
public class PCNDecisionStepActionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PCNDecisionStepActionEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PcnParserProvider.getParser(PcnElementTypes.PCNDecisionStep_3036, getParserElement(),
					PcnVisualIDRegistry.getType(pcn.diagram.edit.parts.PCNDecisionStepActionEditPart.VISUAL_ID));
		}
		return parser;
	}
