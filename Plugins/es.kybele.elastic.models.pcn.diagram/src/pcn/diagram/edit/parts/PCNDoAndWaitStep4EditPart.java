...
import pcn.diagram.edit.policies.PCNDoAndWaitStep4ItemSemanticEditPolicy;
import pcn.diagram.part.PcnVisualIDRegistry;

/**
 * @generated
 */
public class PCNDoAndWaitStep4EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public PCNDoAndWaitStep4EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new PCNDoAndWaitStep4ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PCNDoAndWaitStepAction4EditPart) {
			((PCNDoAndWaitStepAction4EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigurePCNDoAndWaitStepActionFigure());
			return true;
		}
		if (childEditPart instanceof PCNDoAndWaitStepCompartmentLongProcessTags4EditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNDoAndWaitStepFigureExternalRectangle();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((PCNDoAndWaitStepCompartmentLongProcessTags4EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof PCNDoAndWaitStepCompartmentLongProcessTags4EditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNDoAndWaitStepFigureExternalRectangle();
			pane.remove(((PCNDoAndWaitStepCompartmentLongProcessTags4EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof PCNDoAndWaitStepCompartmentLongProcessTags4EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PcnVisualIDRegistry.getType(PCNDoAndWaitStepAction4EditPart.VISUAL_ID));
	}
