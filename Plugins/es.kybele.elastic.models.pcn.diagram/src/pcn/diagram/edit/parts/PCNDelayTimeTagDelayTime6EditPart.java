 ...
 * @generated
 */
public class PCNDelayTimeTagDelayTime6EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PCNDelayTimeTagDelayTime6EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PcnParserProvider.getParser(PcnElementTypes.PCNDelayTimeTag_3203, getParserElement(),
					PcnVisualIDRegistry.getType(pcn.diagram.edit.parts.PCNDelayTimeTagDelayTime6EditPart.VISUAL_ID));
		}
		return parser;
	}
