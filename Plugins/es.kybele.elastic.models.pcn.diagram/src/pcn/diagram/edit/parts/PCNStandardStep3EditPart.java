...
import pcn.diagram.edit.parts.PCNStandardStep2EditPart.PCNStandardStepFigure;
import pcn.diagram.edit.policies.PCNStandardStep3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class PCNStandardStep3EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public PCNStandardStep3EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new PCNStandardStep3ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PCNStandardStepAction3EditPart) {
			((PCNStandardStepAction3EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigurePCNStandardStepActionFigure());
			return true;
		}
		if (childEditPart instanceof PCNStandardStepCompartmentStandardProcessTags3EditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNStandardStepFigureExternalRectangle();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((PCNStandardStepCompartmentStandardProcessTags3EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof PCNStandardStepCompartmentStandardProcessTags3EditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNStandardStepFigureExternalRectangle();
			pane.remove(((PCNStandardStepCompartmentStandardProcessTags3EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof PCNStandardStepCompartmentStandardProcessTags3EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PcnVisualIDRegistry.getType(PCNStandardStepAction3EditPart.VISUAL_ID));
	}
