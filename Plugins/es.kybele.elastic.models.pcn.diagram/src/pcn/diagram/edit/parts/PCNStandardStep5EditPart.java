...
import pcn.diagram.edit.policies.PCNStandardStep5ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class PCNStandardStep5EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public PCNStandardStep5EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new PCNStandardStep5ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PCNStandardStepAction5EditPart) {
			((PCNStandardStepAction5EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigurePCNStandardStepActionFigure());
			return true;
		}
		if (childEditPart instanceof PCNStandardStepCompartmentStandardProcessTags5EditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNStandardStepFigureExternalRectangle();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((PCNStandardStepCompartmentStandardProcessTags5EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof PCNStandardStepCompartmentStandardProcessTags5EditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNStandardStepFigureExternalRectangle();
			pane.remove(((PCNStandardStepCompartmentStandardProcessTags5EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof PCNStandardStepCompartmentStandardProcessTags5EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PcnVisualIDRegistry.getType(PCNStandardStepAction5EditPart.VISUAL_ID));
	}
