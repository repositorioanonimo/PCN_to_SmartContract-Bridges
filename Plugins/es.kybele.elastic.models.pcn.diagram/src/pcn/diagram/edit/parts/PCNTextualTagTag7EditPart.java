 ...
 * @generated
 */
public class PCNTextualTagTag7EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PCNTextualTagTag7EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PcnParserProvider.getParser(PcnElementTypes.PCNTextualTag_3174, getParserElement(),
					PcnVisualIDRegistry.getType(pcn.diagram.edit.parts.PCNTextualTagTag7EditPart.VISUAL_ID));
		}
		return parser;
	}
