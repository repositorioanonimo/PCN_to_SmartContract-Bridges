...
import pcn.diagram.edit.policies.PCNWaitStep4ItemSemanticEditPolicy;
import pcn.diagram.part.PcnVisualIDRegistry;

/**
 * @generated
 */
public class PCNWaitStep4EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public PCNWaitStep4EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new PCNWaitStep4ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PCNWaitStepAction4EditPart) {
			((PCNWaitStepAction4EditPart) childEditPart).setLabel(getPrimaryShape().getFigurePCNWaitStepActionFigure());
			return true;
		}
		if (childEditPart instanceof PCNWaitStepCompartmentWaitProcessTags4EditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNWaitStepFigureExternalTriangle();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((PCNWaitStepCompartmentWaitProcessTags4EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof PCNWaitStepCompartmentWaitProcessTags4EditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNWaitStepFigureExternalTriangle();
			pane.remove(((PCNWaitStepCompartmentWaitProcessTags4EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof PCNWaitStepCompartmentWaitProcessTags4EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PcnVisualIDRegistry.getType(PCNWaitStepAction4EditPart.VISUAL_ID));
	}
