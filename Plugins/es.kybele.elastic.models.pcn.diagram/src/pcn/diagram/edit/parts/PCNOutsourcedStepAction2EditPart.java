 ...
 * @generated
 */
public class PCNOutsourcedStepAction2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PCNOutsourcedStepAction2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PcnParserProvider.getParser(PcnElementTypes.PCNOutsourcedStep_3032, getParserElement(),
					PcnVisualIDRegistry.getType(pcn.diagram.edit.parts.PCNOutsourcedStepAction2EditPart.VISUAL_ID));
		}
		return parser;
	}
