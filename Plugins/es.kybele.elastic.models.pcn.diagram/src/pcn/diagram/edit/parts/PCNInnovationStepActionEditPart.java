 ...
 * @generated
 */
public class PCNInnovationStepActionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PCNInnovationStepActionEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PcnParserProvider.getParser(PcnElementTypes.PCNInnovationStep_3026, getParserElement(),
					PcnVisualIDRegistry.getType(pcn.diagram.edit.parts.PCNInnovationStepActionEditPart.VISUAL_ID));
		}
		return parser;
	}
