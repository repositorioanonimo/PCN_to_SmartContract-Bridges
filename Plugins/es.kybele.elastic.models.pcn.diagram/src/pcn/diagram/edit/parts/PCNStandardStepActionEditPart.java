 ...
 * @generated
 */
public class PCNStandardStepActionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PCNStandardStepActionEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PcnParserProvider.getParser(PcnElementTypes.PCNStandardStep_3011, getParserElement(),
					PcnVisualIDRegistry.getType(pcn.diagram.edit.parts.PCNStandardStepActionEditPart.VISUAL_ID));
		}
		return parser;
	}
