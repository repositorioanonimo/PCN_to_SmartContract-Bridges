...
import pcn.diagram.edit.policies.PCNDecisionStep3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class PCNDecisionStep3EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public PCNDecisionStep3EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new PCNDecisionStep3ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PCNDecisionStepAction3EditPart) {
			((PCNDecisionStepAction3EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigurePCNDecisionStepActionFigure());
			return true;
		}
		if (childEditPart instanceof PCNDecisionStepCompartmentDecisionProcessTags3EditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNDecisionStepFigureExternalDiamond();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((PCNDecisionStepCompartmentDecisionProcessTags3EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof PCNDecisionStepCompartmentDecisionProcessTags3EditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNDecisionStepFigureExternalDiamond();
			pane.remove(((PCNDecisionStepCompartmentDecisionProcessTags3EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof PCNDecisionStepCompartmentDecisionProcessTags3EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PcnVisualIDRegistry.getType(PCNDecisionStepAction3EditPart.VISUAL_ID));
	}
