 ...
 * @generated
 */
public class PCNStandardStepAction5EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PCNStandardStepAction5EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PcnParserProvider.getParser(PcnElementTypes.PCNStandardStep_3015, getParserElement(),
					PcnVisualIDRegistry.getType(pcn.diagram.edit.parts.PCNStandardStepAction5EditPart.VISUAL_ID));
		}
		return parser;
	}
