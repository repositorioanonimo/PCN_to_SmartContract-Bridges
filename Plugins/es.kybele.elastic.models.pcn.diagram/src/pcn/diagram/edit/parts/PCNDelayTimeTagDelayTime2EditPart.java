 ...
 * @generated
 */
public class PCNDelayTimeTagDelayTime2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PCNDelayTimeTagDelayTime2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PcnParserProvider.getParser(PcnElementTypes.PCNDelayTimeTag_3199, getParserElement(),
					PcnVisualIDRegistry.getType(pcn.diagram.edit.parts.PCNDelayTimeTagDelayTime2EditPart.VISUAL_ID));
		}
		return parser;
	}
