 ...
 * @generated
 */
public class PCNOutsourcedStepAction3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PCNOutsourcedStepAction3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PcnParserProvider.getParser(PcnElementTypes.PCNOutsourcedStep_3033, getParserElement(),
					PcnVisualIDRegistry.getType(pcn.diagram.edit.parts.PCNOutsourcedStepAction3EditPart.VISUAL_ID));
		}
		return parser;
	}
