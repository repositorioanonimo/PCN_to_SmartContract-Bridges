 ...
 * @generated
 */
public class PCNTextualTagTag2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PCNTextualTagTag2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PcnParserProvider.getParser(PcnElementTypes.PCNTextualTag_3169, getParserElement(),
					PcnVisualIDRegistry.getType(pcn.diagram.edit.parts.PCNTextualTagTag2EditPart.VISUAL_ID));
		}
		return parser;
	}
