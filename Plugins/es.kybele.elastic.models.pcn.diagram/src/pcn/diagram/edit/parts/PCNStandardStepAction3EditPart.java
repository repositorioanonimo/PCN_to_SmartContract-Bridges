 ...
 * @generated
 */
public class PCNStandardStepAction3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PCNStandardStepAction3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PcnParserProvider.getParser(PcnElementTypes.PCNStandardStep_3013, getParserElement(),
					PcnVisualIDRegistry.getType(pcn.diagram.edit.parts.PCNStandardStepAction3EditPart.VISUAL_ID));
		}
		return parser;
	}
