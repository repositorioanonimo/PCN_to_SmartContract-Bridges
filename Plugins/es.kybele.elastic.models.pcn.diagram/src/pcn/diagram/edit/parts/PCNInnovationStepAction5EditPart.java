 ...
 * @generated
 */
public class PCNInnovationStepAction5EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PCNInnovationStepAction5EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PcnParserProvider.getParser(PcnElementTypes.PCNInnovationStep_3030, getParserElement(),
					PcnVisualIDRegistry.getType(pcn.diagram.edit.parts.PCNInnovationStepAction5EditPart.VISUAL_ID));
		}
		return parser;
	}
