...
import pcn.diagram.edit.policies.PCNInnovationStep3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class PCNInnovationStep3EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public PCNInnovationStep3EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new PCNInnovationStep3ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PCNInnovationStepAction3EditPart) {
			((PCNInnovationStepAction3EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigurePCNInnovationStepActionFigure());
			return true;
		}
		if (childEditPart instanceof PCNInnovationStepCompartmentHighlightTags3EditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNInnovationStepFigureExternalRectangle();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((PCNInnovationStepCompartmentHighlightTags3EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof PCNInnovationStepCompartmentHighlightTags3EditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNInnovationStepFigureExternalRectangle();
			pane.remove(((PCNInnovationStepCompartmentHighlightTags3EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof PCNInnovationStepCompartmentHighlightTags3EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PcnVisualIDRegistry.getType(PCNInnovationStepAction3EditPart.VISUAL_ID));
	}
