...
import pcn.diagram.edit.policies.PCNReference2ItemSemanticEditPolicy;
import pcn.diagram.part.PcnVisualIDRegistry;

/**
 * @generated
 */
public class PCNReference2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public PCNReference2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new PCNReference2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PCNReferenceLetter2EditPart) {
			((PCNReferenceLetter2EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigurePCNReferenceLetterFigure());
			return true;
		}
		if (childEditPart instanceof PCNReferenceNumber2EditPart) {
			((PCNReferenceNumber2EditPart) childEditPart)
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PcnVisualIDRegistry.getType(PCNReferenceLetter2EditPart.VISUAL_ID));
	}
