...
import pcn.diagram.edit.parts.PCNOutsourcedStepEditPart.PCNOutsourcedStepFigure;
import pcn.diagram.edit.policies.PCNOutsourcedStep5ItemSemanticEditPolicy;
import pcn.diagram.part.PcnVisualIDRegistry;

/**
 * @generated
 */
public class PCNOutsourcedStep5EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public PCNOutsourcedStep5EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new PCNOutsourcedStep5ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PCNOutsourcedStepAction5EditPart) {
			((PCNOutsourcedStepAction5EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigurePCNOutsourcedStepActionFigure());
			return true;
		}
		if (childEditPart instanceof PCNOutsourcedStepCompartmentPreparationTags5EditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNOutsourcedStepFigureExternalRectangle();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((PCNOutsourcedStepCompartmentPreparationTags5EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof PCNOutsourcedStepCompartmentPreparationTags5EditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNOutsourcedStepFigureExternalRectangle();
			pane.remove(((PCNOutsourcedStepCompartmentPreparationTags5EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof PCNOutsourcedStepCompartmentPreparationTags5EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PcnVisualIDRegistry.getType(PCNOutsourcedStepAction5EditPart.VISUAL_ID));
	}
