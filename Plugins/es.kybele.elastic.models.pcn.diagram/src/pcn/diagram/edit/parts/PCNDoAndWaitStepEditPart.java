...
import pcn.diagram.edit.policies.PCNDoAndWaitStepItemSemanticEditPolicy;
 ...
 * @generated
 */
public class PCNDoAndWaitStepEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public PCNDoAndWaitStepEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new PCNDoAndWaitStepItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PCNDoAndWaitStepActionEditPart) {
			((PCNDoAndWaitStepActionEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigurePCNDoAndWaitStepActionFigure());
			return true;
		}
		if (childEditPart instanceof PCNDoAndWaitStepCompartmentLongProcessTagsEditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNDoAndWaitStepFigureExternalRectangle();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((PCNDoAndWaitStepCompartmentLongProcessTagsEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof PCNDoAndWaitStepCompartmentLongProcessTagsEditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNDoAndWaitStepFigureExternalRectangle();
			pane.remove(((PCNDoAndWaitStepCompartmentLongProcessTagsEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof PCNDoAndWaitStepCompartmentLongProcessTagsEditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PcnVisualIDRegistry.getType(PCNDoAndWaitStepActionEditPart.VISUAL_ID));
	}
