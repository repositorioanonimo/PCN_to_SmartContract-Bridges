 ...
 * @generated
 */
public class PCNWaitStepActionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PCNWaitStepActionEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PcnParserProvider.getParser(PcnElementTypes.PCNWaitStep_3021, getParserElement(),
					PcnVisualIDRegistry.getType(pcn.diagram.edit.parts.PCNWaitStepActionEditPart.VISUAL_ID));
		}
		return parser;
	}
