 ...
 * @generated
 */
public class PCNDelayTimeTagDelayTime5EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PCNDelayTimeTagDelayTime5EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PcnParserProvider.getParser(PcnElementTypes.PCNDelayTimeTag_3202, getParserElement(),
					PcnVisualIDRegistry.getType(pcn.diagram.edit.parts.PCNDelayTimeTagDelayTime5EditPart.VISUAL_ID));
		}
		return parser;
	}
