 ...
 * @generated
 */
public class PCNOutsourcedStepAction5EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PCNOutsourcedStepAction5EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PcnParserProvider.getParser(PcnElementTypes.PCNOutsourcedStep_3035, getParserElement(),
					PcnVisualIDRegistry.getType(pcn.diagram.edit.parts.PCNOutsourcedStepAction5EditPart.VISUAL_ID));
		}
		return parser;
	}
