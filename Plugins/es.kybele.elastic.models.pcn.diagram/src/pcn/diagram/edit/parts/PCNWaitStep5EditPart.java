...
import pcn.diagram.edit.policies.PCNWaitStep5ItemSemanticEditPolicy;
import pcn.diagram.part.PcnVisualIDRegistry;

/**
 * @generated
 */
public class PCNWaitStep5EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public PCNWaitStep5EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new PCNWaitStep5ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PCNWaitStepAction5EditPart) {
			((PCNWaitStepAction5EditPart) childEditPart).setLabel(getPrimaryShape().getFigurePCNWaitStepActionFigure());
			return true;
		}
		if (childEditPart instanceof PCNWaitStepCompartmentWaitProcessTags5EditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNWaitStepFigureExternalTriangle();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((PCNWaitStepCompartmentWaitProcessTags5EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof PCNWaitStepCompartmentWaitProcessTags5EditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNWaitStepFigureExternalTriangle();
			pane.remove(((PCNWaitStepCompartmentWaitProcessTags5EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof PCNWaitStepCompartmentWaitProcessTags5EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PcnVisualIDRegistry.getType(PCNWaitStepAction5EditPart.VISUAL_ID));
	}
