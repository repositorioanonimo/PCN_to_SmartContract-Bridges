 ...
 * @generated
 */
public class PCNReferenceLetter2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PCNReferenceLetter2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = PcnParserProvider.getParser(PcnElementTypes.PCNReference_3042, getParserElement(),
					PcnVisualIDRegistry.getType(pcn.diagram.edit.parts.PCNReferenceLetter2EditPart.VISUAL_ID));
		}
		return parser;
	}
