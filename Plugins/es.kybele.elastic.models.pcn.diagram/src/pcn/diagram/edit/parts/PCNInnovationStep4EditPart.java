...
import pcn.diagram.edit.policies.PCNInnovationStep4ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class PCNInnovationStep4EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public PCNInnovationStep4EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new PCNInnovationStep4ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PCNInnovationStepAction4EditPart) {
			((PCNInnovationStepAction4EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigurePCNInnovationStepActionFigure());
			return true;
		}
		if (childEditPart instanceof PCNInnovationStepCompartmentHighlightTags4EditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNInnovationStepFigureExternalRectangle();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((PCNInnovationStepCompartmentHighlightTags4EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof PCNInnovationStepCompartmentHighlightTags4EditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNInnovationStepFigureExternalRectangle();
			pane.remove(((PCNInnovationStepCompartmentHighlightTags4EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof PCNInnovationStepCompartmentHighlightTags4EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PcnVisualIDRegistry.getType(PCNInnovationStepAction4EditPart.VISUAL_ID));
	}
