 ...
 * @generated
 */
public class PCNDoAndWaitStepActionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PCNDoAndWaitStepActionEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PcnParserProvider.getParser(PcnElementTypes.PCNDoAndWaitStep_3016, getParserElement(),
					PcnVisualIDRegistry.getType(pcn.diagram.edit.parts.PCNDoAndWaitStepActionEditPart.VISUAL_ID));
		}
		return parser;
	}
