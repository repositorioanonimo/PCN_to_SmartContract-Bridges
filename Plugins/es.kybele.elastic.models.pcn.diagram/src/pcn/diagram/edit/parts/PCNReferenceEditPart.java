...
import pcn.diagram.edit.policies.PCNReferenceItemSemanticEditPolicy;
import pcn.diagram.part.PcnVisualIDRegistry;

/**
 * @generated
 */
public class PCNReferenceEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public PCNReferenceEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new PCNReferenceItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PCNReferenceLetterEditPart) {
			((PCNReferenceLetterEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigurePCNReferenceLetterFigure());
			return true;
		}
		if (childEditPart instanceof PCNReferenceNumberEditPart) {
			((PCNReferenceNumberEditPart) childEditPart)
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PcnVisualIDRegistry.getType(PCNReferenceLetterEditPart.VISUAL_ID));
	}
