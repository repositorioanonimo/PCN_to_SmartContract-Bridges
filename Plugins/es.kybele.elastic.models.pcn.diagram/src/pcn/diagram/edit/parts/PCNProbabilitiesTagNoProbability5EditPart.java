 ...
 * @generated
 */
public class PCNProbabilitiesTagNoProbability5EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PCNProbabilitiesTagNoProbability5EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = PcnParserProvider.getParser(PcnElementTypes.PCNProbabilitiesTag_3212, getParserElement(),
					PcnVisualIDRegistry
							.getType(pcn.diagram.edit.parts.PCNProbabilitiesTagNoProbability5EditPart.VISUAL_ID));
		}
		return parser;
	}
