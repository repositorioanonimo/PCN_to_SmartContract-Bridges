 ...
 * @generated
 */
public class PCNProcessEntityNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PCNProcessEntityNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = PcnParserProvider.getParser(PcnElementTypes.PCNProcessEntity_2001, getParserElement(),
					PcnVisualIDRegistry.getType(pcn.diagram.edit.parts.PCNProcessEntityNameEditPart.VISUAL_ID));
		}
		return parser;
	}
