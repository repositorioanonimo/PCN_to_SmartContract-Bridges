...
public class WrappingLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(PcnVisualIDRegistry.getType(pcn.diagram.edit.parts.WrappingLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PcnParserProvider.getParser(PcnElementTypes.PCNDecisionStepPCNNegativeDecision_4007,
					getParserElement(),
					PcnVisualIDRegistry.getType(pcn.diagram.edit.parts.WrappingLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
