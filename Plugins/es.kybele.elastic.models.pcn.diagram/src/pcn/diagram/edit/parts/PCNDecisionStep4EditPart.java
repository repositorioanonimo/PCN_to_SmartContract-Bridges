...
import pcn.diagram.edit.policies.PCNDecisionStep4ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class PCNDecisionStep4EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public PCNDecisionStep4EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new PCNDecisionStep4ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PCNDecisionStepAction4EditPart) {
			((PCNDecisionStepAction4EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigurePCNDecisionStepActionFigure());
			return true;
		}
		if (childEditPart instanceof PCNDecisionStepCompartmentDecisionProcessTags4EditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNDecisionStepFigureExternalDiamond();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((PCNDecisionStepCompartmentDecisionProcessTags4EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof PCNDecisionStepCompartmentDecisionProcessTags4EditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNDecisionStepFigureExternalDiamond();
			pane.remove(((PCNDecisionStepCompartmentDecisionProcessTags4EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof PCNDecisionStepCompartmentDecisionProcessTags4EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PcnVisualIDRegistry.getType(PCNDecisionStepAction4EditPart.VISUAL_ID));
	}
