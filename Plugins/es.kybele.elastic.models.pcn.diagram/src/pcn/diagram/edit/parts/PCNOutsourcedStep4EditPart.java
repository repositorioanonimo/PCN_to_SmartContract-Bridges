...
import pcn.diagram.edit.policies.PCNOutsourcedStep4ItemSemanticEditPolicy;
import pcn.diagram.part.PcnVisualIDRegistry;

/**
 * @generated
 */
public class PCNOutsourcedStep4EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public PCNOutsourcedStep4EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new PCNOutsourcedStep4ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PCNOutsourcedStepAction4EditPart) {
			((PCNOutsourcedStepAction4EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigurePCNOutsourcedStepActionFigure());
			return true;
		}
		if (childEditPart instanceof PCNOutsourcedStepCompartmentPreparationTags4EditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNOutsourcedStepFigureExternalRectangle();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((PCNOutsourcedStepCompartmentPreparationTags4EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof PCNOutsourcedStepCompartmentPreparationTags4EditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNOutsourcedStepFigureExternalRectangle();
			pane.remove(((PCNOutsourcedStepCompartmentPreparationTags4EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof PCNOutsourcedStepCompartmentPreparationTags4EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PcnVisualIDRegistry.getType(PCNOutsourcedStepAction4EditPart.VISUAL_ID));
	}
