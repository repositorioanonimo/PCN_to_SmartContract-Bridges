 ...
 * @generated
 */
public class PCNReferenceNumberEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PCNReferenceNumberEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = PcnParserProvider.getParser(PcnElementTypes.PCNReference_3041, getParserElement(),
					PcnVisualIDRegistry.getType(pcn.diagram.edit.parts.PCNReferenceNumberEditPart.VISUAL_ID));
		}
		return parser;
	}
