 ...
 * @generated
 */
public class PCNProcessEntityNameOrderEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PCNProcessEntityNameOrderEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PcnParserProvider.getParser(PcnElementTypes.PCNProcessEntity_2001, getParserElement(),
					PcnVisualIDRegistry.getType(pcn.diagram.edit.parts.PCNProcessEntityNameOrderEditPart.VISUAL_ID));
		}
		return parser;
	}
