...
import pcn.diagram.edit.policies.PCNReference3ItemSemanticEditPolicy;
import pcn.diagram.part.PcnVisualIDRegistry;

/**
 * @generated
 */
public class PCNReference3EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public PCNReference3EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new PCNReference3ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PCNReferenceLetter3EditPart) {
			((PCNReferenceLetter3EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigurePCNReferenceLetterFigure());
			return true;
		}
		if (childEditPart instanceof PCNReferenceNumber3EditPart) {
			((PCNReferenceNumber3EditPart) childEditPart)
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PcnVisualIDRegistry.getType(PCNReferenceLetter3EditPart.VISUAL_ID));
	}
