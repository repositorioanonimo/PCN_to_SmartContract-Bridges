 ...
 * @generated
 */
public class PCNReferenceLetterEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PCNReferenceLetterEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PcnParserProvider.getParser(PcnElementTypes.PCNReference_3041, getParserElement(),
					PcnVisualIDRegistry.getType(pcn.diagram.edit.parts.PCNReferenceLetterEditPart.VISUAL_ID));
		}
		return parser;
	}
