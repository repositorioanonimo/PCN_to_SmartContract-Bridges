 ...
 * @generated
 */
public class PCNDelayTimeTagDelayTime4EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PCNDelayTimeTagDelayTime4EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PcnParserProvider.getParser(PcnElementTypes.PCNDelayTimeTag_3201, getParserElement(),
					PcnVisualIDRegistry.getType(pcn.diagram.edit.parts.PCNDelayTimeTagDelayTime4EditPart.VISUAL_ID));
		}
		return parser;
	}
