 ...
 * @generated
 */
public class PCNTextualTagTag9EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PCNTextualTagTag9EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PcnParserProvider.getParser(PcnElementTypes.PCNTextualTag_3176, getParserElement(),
					PcnVisualIDRegistry.getType(pcn.diagram.edit.parts.PCNTextualTagTag9EditPart.VISUAL_ID));
		}
		return parser;
	}
