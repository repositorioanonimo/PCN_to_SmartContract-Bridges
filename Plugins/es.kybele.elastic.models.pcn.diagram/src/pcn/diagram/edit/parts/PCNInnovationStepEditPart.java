...
import pcn.diagram.edit.policies.PCNInnovationStepItemSemanticEditPolicy;
 ...
 * @generated
 */
public class PCNInnovationStepEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public PCNInnovationStepEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new PCNInnovationStepItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PCNInnovationStepActionEditPart) {
			((PCNInnovationStepActionEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigurePCNInnovationStepActionFigure());
			return true;
		}
		if (childEditPart instanceof PCNInnovationStepCompartmentHighlightTagsEditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNInnovationStepFigureExternalRectangle();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((PCNInnovationStepCompartmentHighlightTagsEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof PCNInnovationStepCompartmentHighlightTagsEditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNInnovationStepFigureExternalRectangle();
			pane.remove(((PCNInnovationStepCompartmentHighlightTagsEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof PCNInnovationStepCompartmentHighlightTagsEditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PcnVisualIDRegistry.getType(PCNInnovationStepActionEditPart.VISUAL_ID));
	}
