 ...
 * @generated
 */
public class PCNInnovationStepAction3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PCNInnovationStepAction3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PcnParserProvider.getParser(PcnElementTypes.PCNInnovationStep_3028, getParserElement(),
					PcnVisualIDRegistry.getType(pcn.diagram.edit.parts.PCNInnovationStepAction3EditPart.VISUAL_ID));
		}
		return parser;
	}
