...
import pcn.diagram.edit.policies.PCNDecisionStep5ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class PCNDecisionStep5EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public PCNDecisionStep5EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new PCNDecisionStep5ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PCNDecisionStepAction5EditPart) {
			((PCNDecisionStepAction5EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigurePCNDecisionStepActionFigure());
			return true;
		}
		if (childEditPart instanceof PCNDecisionStepCompartmentDecisionProcessTags5EditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNDecisionStepFigureExternalDiamond();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((PCNDecisionStepCompartmentDecisionProcessTags5EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof PCNDecisionStepCompartmentDecisionProcessTags5EditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNDecisionStepFigureExternalDiamond();
			pane.remove(((PCNDecisionStepCompartmentDecisionProcessTags5EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof PCNDecisionStepCompartmentDecisionProcessTags5EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PcnVisualIDRegistry.getType(PCNDecisionStepAction5EditPart.VISUAL_ID));
	}
