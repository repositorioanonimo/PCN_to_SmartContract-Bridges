...
import pcn.diagram.edit.policies.PCNInnovationStep2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class PCNInnovationStep2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public PCNInnovationStep2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new PCNInnovationStep2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PCNInnovationStepAction2EditPart) {
			((PCNInnovationStepAction2EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigurePCNInnovationStepActionFigure());
			return true;
		}
		if (childEditPart instanceof PCNInnovationStepCompartmentHighlightTags2EditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNInnovationStepFigureExternalRectangle();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((PCNInnovationStepCompartmentHighlightTags2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof PCNInnovationStepCompartmentHighlightTags2EditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNInnovationStepFigureExternalRectangle();
			pane.remove(((PCNInnovationStepCompartmentHighlightTags2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof PCNInnovationStepCompartmentHighlightTags2EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PcnVisualIDRegistry.getType(PCNInnovationStepAction2EditPart.VISUAL_ID));
	}
