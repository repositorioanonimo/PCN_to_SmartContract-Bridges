...
import pcn.diagram.edit.policies.PCNDecisionStepItemSemanticEditPolicy;
import pcn.diagram.part.PcnVisualIDRegistry;

/**
 * @generated
 */
public class PCNDecisionStepEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public PCNDecisionStepEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new PCNDecisionStepItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PCNDecisionStepActionEditPart) {
			((PCNDecisionStepActionEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigurePCNDecisionStepActionFigure());
			return true;
		}
		if (childEditPart instanceof PCNDecisionStepCompartmentDecisionProcessTagsEditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNDecisionStepFigureExternalDiamond();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((PCNDecisionStepCompartmentDecisionProcessTagsEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof PCNDecisionStepCompartmentDecisionProcessTagsEditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNDecisionStepFigureExternalDiamond();
			pane.remove(((PCNDecisionStepCompartmentDecisionProcessTagsEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof PCNDecisionStepCompartmentDecisionProcessTagsEditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PcnVisualIDRegistry.getType(PCNDecisionStepActionEditPart.VISUAL_ID));
	}
