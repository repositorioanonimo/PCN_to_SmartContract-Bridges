 ...
 * @generated
 */
public class PCNReferenceLetter5EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PCNReferenceLetter5EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = PcnParserProvider.getParser(PcnElementTypes.PCNReference_3045, getParserElement(),
					PcnVisualIDRegistry.getType(pcn.diagram.edit.parts.PCNReferenceLetter5EditPart.VISUAL_ID));
		}
		return parser;
	}
