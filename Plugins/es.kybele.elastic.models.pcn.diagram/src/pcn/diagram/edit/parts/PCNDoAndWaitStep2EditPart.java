...
import pcn.diagram.edit.policies.PCNDoAndWaitStep2ItemSemanticEditPolicy;
import pcn.diagram.part.PcnVisualIDRegistry;

/**
 * @generated
 */
public class PCNDoAndWaitStep2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public PCNDoAndWaitStep2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new PCNDoAndWaitStep2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PCNDoAndWaitStepAction2EditPart) {
			((PCNDoAndWaitStepAction2EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigurePCNDoAndWaitStepActionFigure());
			return true;
		}
		if (childEditPart instanceof PCNDoAndWaitStepCompartmentLongProcessTags2EditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNDoAndWaitStepFigureExternalRectangle();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((PCNDoAndWaitStepCompartmentLongProcessTags2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof PCNDoAndWaitStepCompartmentLongProcessTags2EditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNDoAndWaitStepFigureExternalRectangle();
			pane.remove(((PCNDoAndWaitStepCompartmentLongProcessTags2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof PCNDoAndWaitStepCompartmentLongProcessTags2EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PcnVisualIDRegistry.getType(PCNDoAndWaitStepAction2EditPart.VISUAL_ID));
	}
