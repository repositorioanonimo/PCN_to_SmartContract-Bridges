 ...
 * @generated
 */
public class PCNTextualTagTagEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PCNTextualTagTagEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PcnParserProvider.getParser(PcnElementTypes.PCNTextualTag_3168, getParserElement(),
					PcnVisualIDRegistry.getType(pcn.diagram.edit.parts.PCNTextualTagTagEditPart.VISUAL_ID));
		}
		return parser;
	}
