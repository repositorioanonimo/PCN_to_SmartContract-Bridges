 ...
 * @generated
 */
public class PCNProbabilitiesTagNoProbability4EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PCNProbabilitiesTagNoProbability4EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = PcnParserProvider.getParser(PcnElementTypes.PCNProbabilitiesTag_3211, getParserElement(),
					PcnVisualIDRegistry
							.getType(pcn.diagram.edit.parts.PCNProbabilitiesTagNoProbability4EditPart.VISUAL_ID));
		}
		return parser;
	}
