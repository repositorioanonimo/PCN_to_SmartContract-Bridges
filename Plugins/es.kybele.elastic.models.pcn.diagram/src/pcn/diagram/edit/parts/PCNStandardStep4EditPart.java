...
import pcn.diagram.edit.policies.PCNStandardStep4ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class PCNStandardStep4EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public PCNStandardStep4EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new PCNStandardStep4ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PCNStandardStepAction4EditPart) {
			((PCNStandardStepAction4EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigurePCNStandardStepActionFigure());
			return true;
		}
		if (childEditPart instanceof PCNStandardStepCompartmentStandardProcessTags4EditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNStandardStepFigureExternalRectangle();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((PCNStandardStepCompartmentStandardProcessTags4EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof PCNStandardStepCompartmentStandardProcessTags4EditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNStandardStepFigureExternalRectangle();
			pane.remove(((PCNStandardStepCompartmentStandardProcessTags4EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof PCNStandardStepCompartmentStandardProcessTags4EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PcnVisualIDRegistry.getType(PCNStandardStepAction4EditPart.VISUAL_ID));
	}
