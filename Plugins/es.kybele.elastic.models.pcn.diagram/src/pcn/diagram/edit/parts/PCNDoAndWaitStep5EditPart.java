...
import pcn.diagram.edit.policies.PCNDoAndWaitStep5ItemSemanticEditPolicy;
import pcn.diagram.part.PcnVisualIDRegistry;

/**
 * @generated
 */
public class PCNDoAndWaitStep5EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public PCNDoAndWaitStep5EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new PCNDoAndWaitStep5ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PCNDoAndWaitStepAction5EditPart) {
			((PCNDoAndWaitStepAction5EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigurePCNDoAndWaitStepActionFigure());
			return true;
		}
		if (childEditPart instanceof PCNDoAndWaitStepCompartmentLongProcessTags5EditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNDoAndWaitStepFigureExternalRectangle();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((PCNDoAndWaitStepCompartmentLongProcessTags5EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof PCNDoAndWaitStepCompartmentLongProcessTags5EditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNDoAndWaitStepFigureExternalRectangle();
			pane.remove(((PCNDoAndWaitStepCompartmentLongProcessTags5EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof PCNDoAndWaitStepCompartmentLongProcessTags5EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PcnVisualIDRegistry.getType(PCNDoAndWaitStepAction5EditPart.VISUAL_ID));
	}
