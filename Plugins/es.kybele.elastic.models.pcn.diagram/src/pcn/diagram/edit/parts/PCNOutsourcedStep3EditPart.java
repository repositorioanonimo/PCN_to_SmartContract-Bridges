...
import pcn.diagram.edit.policies.PCNOutsourcedStep3ItemSemanticEditPolicy;
import pcn.diagram.part.PcnVisualIDRegistry;

/**
 * @generated
 */
public class PCNOutsourcedStep3EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public PCNOutsourcedStep3EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new PCNOutsourcedStep3ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PCNOutsourcedStepAction3EditPart) {
			((PCNOutsourcedStepAction3EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigurePCNOutsourcedStepActionFigure());
			return true;
		}
		if (childEditPart instanceof PCNOutsourcedStepCompartmentPreparationTags3EditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNOutsourcedStepFigureExternalRectangle();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((PCNOutsourcedStepCompartmentPreparationTags3EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof PCNOutsourcedStepCompartmentPreparationTags3EditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNOutsourcedStepFigureExternalRectangle();
			pane.remove(((PCNOutsourcedStepCompartmentPreparationTags3EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof PCNOutsourcedStepCompartmentPreparationTags3EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PcnVisualIDRegistry.getType(PCNOutsourcedStepAction3EditPart.VISUAL_ID));
	}
