 ...
 * @generated
 */
public class PCNProbabilitiesTagYesProbability2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PCNProbabilitiesTagYesProbability2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PcnParserProvider.getParser(PcnElementTypes.PCNProbabilitiesTag_3209, getParserElement(),
					PcnVisualIDRegistry
							.getType(pcn.diagram.edit.parts.PCNProbabilitiesTagYesProbability2EditPart.VISUAL_ID));
		}
		return parser;
	}
