...
import pcn.diagram.edit.policies.PCNStandardStepItemSemanticEditPolicy;
 ...
 * @generated
 */
public class PCNStandardStepEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public PCNStandardStepEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new PCNStandardStepItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PCNStandardStepActionEditPart) {
			((PCNStandardStepActionEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigurePCNStandardStepActionFigure());
			return true;
		}
		if (childEditPart instanceof PCNStandardStepCompartmentStandardProcessTagsEditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNStandardStepFigureExternalRectangle();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((PCNStandardStepCompartmentStandardProcessTagsEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof PCNStandardStepCompartmentStandardProcessTagsEditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNStandardStepFigureExternalRectangle();
			pane.remove(((PCNStandardStepCompartmentStandardProcessTagsEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof PCNStandardStepCompartmentStandardProcessTagsEditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PcnVisualIDRegistry.getType(PCNStandardStepActionEditPart.VISUAL_ID));
	}
	...
	public class PCNStandardStepFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			fFigurePCNStandardStepFigureExternalRectangle.setForegroundColor(ColorConstants.black);

			this.add(fFigurePCNStandardStepFigureExternalRectangle, new Rectangle(getMapMode().DPtoLP(0),
					getMapMode().DPtoLP(0), getMapMode().DPtoLP(130), getMapMode().DPtoLP(80)));
			...
			this.add(pCNStandardProcessStepFigureInternalRectangle0, new Rectangle(getMapMode().DPtoLP(15),
					getMapMode().DPtoLP(15), getMapMode().DPtoLP(100), getMapMode().DPtoLP(50)));
