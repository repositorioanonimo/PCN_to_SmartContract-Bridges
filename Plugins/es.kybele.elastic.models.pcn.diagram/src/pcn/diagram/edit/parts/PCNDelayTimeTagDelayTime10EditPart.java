 ...
 * @generated
 */
public class PCNDelayTimeTagDelayTime10EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PCNDelayTimeTagDelayTime10EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PcnParserProvider.getParser(PcnElementTypes.PCNDelayTimeTag_3207, getParserElement(),
					PcnVisualIDRegistry.getType(pcn.diagram.edit.parts.PCNDelayTimeTagDelayTime10EditPart.VISUAL_ID));
		}
		return parser;
	}
