 ...
 * @generated
 */
public class PCNOutsourcedStepActionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PCNOutsourcedStepActionEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PcnParserProvider.getParser(PcnElementTypes.PCNOutsourcedStep_3031, getParserElement(),
					PcnVisualIDRegistry.getType(pcn.diagram.edit.parts.PCNOutsourcedStepActionEditPart.VISUAL_ID));
		}
		return parser;
	}
