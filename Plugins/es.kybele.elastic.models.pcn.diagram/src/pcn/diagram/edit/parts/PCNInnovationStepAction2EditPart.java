 ...
 * @generated
 */
public class PCNInnovationStepAction2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PCNInnovationStepAction2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PcnParserProvider.getParser(PcnElementTypes.PCNInnovationStep_3027, getParserElement(),
					PcnVisualIDRegistry.getType(pcn.diagram.edit.parts.PCNInnovationStepAction2EditPart.VISUAL_ID));
		}
		return parser;
	}
