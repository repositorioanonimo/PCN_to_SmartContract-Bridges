...
import pcn.diagram.edit.policies.PCNWaitStepItemSemanticEditPolicy;
import pcn.diagram.part.PcnVisualIDRegistry;

/**
 * @generated
 */
public class PCNWaitStepEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public PCNWaitStepEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new PCNWaitStepItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PCNWaitStepActionEditPart) {
			((PCNWaitStepActionEditPart) childEditPart).setLabel(getPrimaryShape().getFigurePCNWaitStepActionFigure());
			return true;
		}
		if (childEditPart instanceof PCNWaitStepCompartmentWaitProcessTagsEditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNWaitStepFigureExternalTriangle();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((PCNWaitStepCompartmentWaitProcessTagsEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof PCNWaitStepCompartmentWaitProcessTagsEditPart) {
			IFigure pane = getPrimaryShape().getFigurePCNWaitStepFigureExternalTriangle();
			pane.remove(((PCNWaitStepCompartmentWaitProcessTagsEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof PCNWaitStepCompartmentWaitProcessTagsEditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PcnVisualIDRegistry.getType(PCNWaitStepActionEditPart.VISUAL_ID));
	}
