 ...
 * @generated
 */
public class PCNInnovationStepAction4EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PCNInnovationStepAction4EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PcnParserProvider.getParser(PcnElementTypes.PCNInnovationStep_3029, getParserElement(),
					PcnVisualIDRegistry.getType(pcn.diagram.edit.parts.PCNInnovationStepAction4EditPart.VISUAL_ID));
		}
		return parser;
	}
