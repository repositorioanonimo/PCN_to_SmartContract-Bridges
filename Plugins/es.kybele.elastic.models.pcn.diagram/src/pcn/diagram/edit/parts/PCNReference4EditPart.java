...
import pcn.diagram.edit.policies.PCNReference4ItemSemanticEditPolicy;
import pcn.diagram.part.PcnVisualIDRegistry;

/**
 * @generated
 */
public class PCNReference4EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public PCNReference4EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new PCNReference4ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PCNReferenceLetter4EditPart) {
			((PCNReferenceLetter4EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigurePCNReferenceLetterFigure());
			return true;
		}
		if (childEditPart instanceof PCNReferenceNumber4EditPart) {
			((PCNReferenceNumber4EditPart) childEditPart)
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PcnVisualIDRegistry.getType(PCNReferenceLetter4EditPart.VISUAL_ID));
	}
