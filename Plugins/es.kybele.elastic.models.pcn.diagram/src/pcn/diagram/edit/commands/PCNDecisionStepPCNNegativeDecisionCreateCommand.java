 ...
 * @generated
 */
public class PCNDecisionStepPCNNegativeDecisionCreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	public PCNDecisionStepPCNNegativeDecisionCreateCommand(CreateRelationshipRequest request, EObject source,
			EObject target) {
	...
	*/
	public boolean canExecute() {
		...
		return PcnBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreatePCNDecisionStepPCNNegativeDecision_4007(getSource(), getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setPCNNegativeDecision(getTarget());
		}
