 ...
 * @generated
 */
public class PCNRegularProcessStepPCNDelayedDependencyReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public PCNRegularProcessStepPCNDelayedDependencyReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	*/
	protected boolean canReorientSource() {
		...
		return PcnBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistPCNRegularProcessStepPCNDelayedDependency_4009(getNewSource(), getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return PcnBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistPCNRegularProcessStepPCNDelayedDependency_4009(getOldSource(), getNewTarget());
	}
	...
	*/
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getPCNDelayedDependency().remove(getOldTarget());
		getNewSource().getPCNDelayedDependency().add(getOldTarget());
	...
	*/
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getPCNDelayedDependency().remove(getOldTarget());
		getOldSource().getPCNDelayedDependency().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
