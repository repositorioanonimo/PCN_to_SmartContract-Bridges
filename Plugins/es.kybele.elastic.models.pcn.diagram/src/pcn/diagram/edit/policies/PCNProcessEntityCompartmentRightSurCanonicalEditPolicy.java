 ...
 * @generated
 */
public class PCNProcessEntityCompartmentRightSurCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return PcnPackage.eINSTANCE.getPCNProcessEntity_RightSurrogateInteractions();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PcnNodeDescriptor> childDescriptors = PcnDiagramUpdater
				.getPCNProcessEntityCompartmentRightSur_7004SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PcnNodeDescriptor> childDescriptors = PcnDiagramUpdater
				.getPCNProcessEntityCompartmentRightSur_7004SemanticChildren((View) getHost().getModel());
