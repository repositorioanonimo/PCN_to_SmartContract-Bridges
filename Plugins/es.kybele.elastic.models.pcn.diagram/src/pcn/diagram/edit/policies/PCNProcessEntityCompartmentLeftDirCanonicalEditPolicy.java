 ...
 * @generated
 */
public class PCNProcessEntityCompartmentLeftDirCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return PcnPackage.eINSTANCE.getPCNProcessEntity_LeftDirectInteractions();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PcnNodeDescriptor> childDescriptors = PcnDiagramUpdater
				.getPCNProcessEntityCompartmentLeftDir_7001SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PcnNodeDescriptor> childDescriptors = PcnDiagramUpdater
				.getPCNProcessEntityCompartmentLeftDir_7001SemanticChildren((View) getHost().getModel());
