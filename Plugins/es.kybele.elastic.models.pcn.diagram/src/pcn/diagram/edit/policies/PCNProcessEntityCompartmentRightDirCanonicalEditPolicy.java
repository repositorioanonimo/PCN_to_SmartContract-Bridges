 ...
 * @generated
 */
public class PCNProcessEntityCompartmentRightDirCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return PcnPackage.eINSTANCE.getPCNProcessEntity_RightDirectInteractions();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PcnNodeDescriptor> childDescriptors = PcnDiagramUpdater
				.getPCNProcessEntityCompartmentRightDir_7005SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PcnNodeDescriptor> childDescriptors = PcnDiagramUpdater
				.getPCNProcessEntityCompartmentRightDir_7005SemanticChildren((View) getHost().getModel());
