 ...
 * @generated
 */
public class PCNProcessEntityCompartmentIndCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return PcnPackage.eINSTANCE.getPCNProcessEntity_CenterIndependentInteractionsActivities();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PcnNodeDescriptor> childDescriptors = PcnDiagramUpdater
				.getPCNProcessEntityCompartmentInd_7003SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PcnNodeDescriptor> childDescriptors = PcnDiagramUpdater
				.getPCNProcessEntityCompartmentInd_7003SemanticChildren((View) getHost().getModel());
