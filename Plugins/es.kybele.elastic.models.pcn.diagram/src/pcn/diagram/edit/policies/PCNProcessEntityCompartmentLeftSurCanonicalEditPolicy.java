 ...
 * @generated
 */
public class PCNProcessEntityCompartmentLeftSurCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return PcnPackage.eINSTANCE.getPCNProcessEntity_LeftSurrogateInteractions();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PcnNodeDescriptor> childDescriptors = PcnDiagramUpdater
				.getPCNProcessEntityCompartmentLeftSur_7002SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PcnNodeDescriptor> childDescriptors = PcnDiagramUpdater
				.getPCNProcessEntityCompartmentLeftSur_7002SemanticChildren((View) getHost().getModel());
