...
import pcn.diagram.edit.parts.PCNDecisionStepCompartmentDecisionProcessTags2EditPart;
...
import pcn.diagram.edit.parts.PCNMonetaryBenefit27EditPart;
import pcn.diagram.edit.parts.PCNMonetaryCost27EditPart;

import pcn.diagram.edit.parts.PCNNonMonetaryBenefit27EditPart;
import pcn.diagram.edit.parts.PCNNonMonetaryCost27EditPart;

import pcn.diagram.edit.parts.PCNProbabilitiesTag2EditPart;
...
import pcn.diagram.edit.parts.PCNSyncTag27EditPart;
import pcn.diagram.edit.parts.PCNTextualTag27EditPart;
 ...
 * @generated
 */
public class PCNDecisionStep2ItemSemanticEditPolicy extends PcnBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public PCNDecisionStep2ItemSemanticEditPolicy() {
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (PcnVisualIDRegistry.getVisualID(outgoingLink) == PCNDecisionStepPCNNegativeDecisionEditPart.VISUAL_ID) {
			...
			if (PcnVisualIDRegistry.getVisualID(outgoingLink) == PCNDecisionStepPCNPositiveDecisionEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(outgoingLink.getSource().getElement(), null,
						outgoingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
