...
/**
 * This is the item provider adapter for a {@link pcn.PCNWaitStep} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PCNWaitStepItemProvider extends PCNRegularProcessStepItemProvider {
	/**
	 ...
	 * @generated
	 */
	public PCNWaitStepItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PCNWaitStep"));
	}
	...
	public String getText(Object object) {
		String label = ((PCNWaitStep)object).getAction();
		return label == null || label.length() == 0 ?
			getString("_UI_PCNWaitStep_type") :
			getString("_UI_PCNWaitStep_type") + " " + label;
	}
